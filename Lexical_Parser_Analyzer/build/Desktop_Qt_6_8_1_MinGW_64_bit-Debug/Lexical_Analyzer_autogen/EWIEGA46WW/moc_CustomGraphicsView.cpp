...
static constexpr auto qt_meta_stringdata_ZN18CustomGraphicsViewE = QtMocHelpers::stringData(
    "CustomGraphicsView"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN18CustomGraphicsViewE[] = {
...
Q_CONSTINIT const QMetaObject CustomGraphicsView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18CustomGraphicsViewE.offsetsAndSizes,
    qt_meta_data_ZN18CustomGraphicsViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18CustomGraphicsViewE_t,
        // Q_OBJECT / Q_GADGET
...
void *CustomGraphicsView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18CustomGraphicsViewE.stringdata0))
